...
// --- Main Component ---
const EditPemasukanModal = ({ data: transactionData, visible, onClose: onCloseModal, onSuccess: onSuccessUpdate }) => {
    // --- State Management ---
    ...
    useEffect(() => {
        if (visible && transactionData) {
            setCategories(getAllKategoriPemasukan());
    ...
    const handleUpdateTransaction = () => {
        if (!transactionName || !transactionAmount || !selectedCategoryId || !selectedWalletId) {
    ...
    return (
        <Modal animationType="slide" transparent={false} visible={visible} onRequestClose={onCloseModal}>
            <SafeAreaView style={styles.modalContainer}>
                <ModalHeader title="Edit Transaksi" onClose={onCloseModal} />
...
export default EditPemasukanModal;
