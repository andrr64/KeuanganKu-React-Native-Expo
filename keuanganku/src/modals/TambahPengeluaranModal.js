...
const TambahPengeluaranModal = ({ visible, onClose, onSuccess }) => {
  // --- State Management ---
  ...
  useEffect(() => {
    if (visible) {
      const fetchedCategories = getAllKategoriPengeluaran();
  ...
  return (
    <Modal animationType="slide" transparent={false} visible={visible} onRequestClose={onClose}>
      <SafeAreaView style={styles.modalContainer}>
        <ModalHeader title="Tambah Pengeluaran" onClose={onClose} />
...
export default TambahPengeluaranModal;
